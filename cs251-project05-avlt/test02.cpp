...
TEST_CASE("(5) case 2 at root")
{
  ...
  vector<int> keys = { 100, 80, 120, 60, 90, 85 };
  vector<int> heights = { 1, 1, 0, 0, 2, 0 };
...
TEST_CASE("(7) case 2 right of parent")
{
  ...
  vector<int> keys = { 46, 29, 76, 35, 17, 100, 60, 59, 58 };
...
TEST_CASE("(10) case 3 right of parent")
{
  ...
  vector<int> keys = { 46, 29, 76, 17, 35, 60, 81, 80, 100, 79 };
  vector<int> heights = { 3, 1, 1, 0, 0, 0, 1, 2, 0, 0};
